...
//        private readonly IDbProviderExpressions _exprProvider;
...
//            _exprProvider = ;
//            var helper=new ExpressionWriterHelper();
//            _w = new ExpressionWriter(new SqlServer2012Expressions(),);        
//        }
...
//        {
//            Expression<Func<PostViewModel, bool>> data = p => p.Id==23 && !p.IsActive;
//            _w.Write(data);
...
//        {
//            Expression<Func<PostViewModel, bool>> data = p =>p.IsActive && p.Id == 23;
//            _w.Write(data);
...
//        {
//            Expression<Func<PostViewModel, bool>> data = p => p.IsActive;
//            _w.Write(data);
...
//        {
//            Expression<Func<PostViewModel, bool>> data = p => p.TopicId==2;
//            _w.Write(data);
...
//        {
//            Expression<Func<PostViewModel, bool>> data = p => new[] { 1, 3 }.Contains(p.Id);
//            _w.Write(data);
...
//            bla.Add(1);
//            bla.Add(2);
//            Expression<Func<PostViewModel, bool>> data = p => bla.Contains(p.Id);
//            _w.Write(data);
//            Assert.Equal("[Id] in (@0)",_sb.ToString());
//            Assert.Equal(2,_pm.ToArray().First().As<IList>().Count);
//            Assert.True(_pm.ToArray().First().IsListParam());           
...
//            _exprProvider.Setup(d => d.Length(It.IsAny<string>())).Returns("Title");
//            _w.Write(data);
//            _exprProvider.Verify(d=>d.Length("Title"));            
//        }
...
//            _exprProvider.Setup(d => d.Substring("Title",0,3)).Returns("Title").Verifiable();
//            _w.Write(data);
//            _exprProvider.Verify();
//        }
...
//            _exprProvider.Setup(d => d.Year("CreatedOn")).Returns("Year(CreatedOn)").Verifiable();
//            _w.Write(data);
//            _exprProvider.Verify();
//        }
...
//            _exprProvider.Setup(d => d.Day("CreatedOn")).Returns("Day(CreatedOn)").Verifiable();
//            _w.Write(data);
//            _exprProvider.Verify();
//        }
...
//        {
//            Expression<Func<Post, bool>> data = p => p.SomeId+4*p.SomeId==p.SomeId;
//            _w.Write(data);
//            Assert.Equal("(([SomeId] + (4 * [SomeId])) = [SomeId])",_sb.ToString());
//        }

//        [Fact]
//        public void property_is_null()
//        {
//            Expression<Func<PostViewModel, bool>> data = p => p.TopicId==null;
//            _w.Write(data);
