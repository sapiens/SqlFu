...
namespace SqlFu.DDL.Generators.SqlServer
{
    ...
    {
        private SqlServerColumnWriter _writer;
        ...
        {
            Builder.AppendFormat("alter table {0} alter column {1} ", SqlServerProvider.EscapeIdentifier(col.TableName), SqlServerProvider.EscapeIdentifier(col.Current.Name));
            _writer.Write(col);
            Builder.AppendLine(";");
        }
